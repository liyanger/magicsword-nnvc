/**
 * @file:   文件描述-View
 * @author: 模板编译工具，基于node
 * @depend: 无
 * @date:   2014-11-11
 *
 * 使用例子：node template-complie.js(在当前目录的命令行中，敲入命令)
 */

// 配置项
var options = {
    src: '../src', //  待编译文件的根路径
    fileNameReg: /-template.html$/  // 模板文件的读取规则

};

// 任务执行区域
var fs = require('fs');
var templateFiles = readAllFile(options.src, options.fileNameReg);
